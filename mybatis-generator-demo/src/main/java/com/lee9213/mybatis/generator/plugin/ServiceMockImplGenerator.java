...
// */
//public class ServiceMockImplGenerator extends BaseGenerator {
//
//    private static Logger LOGGER = LoggerFactory.getLogger(ServiceMockImplGenerator.class);
//
//    public ServiceMockImplGenerator(String serviceVm, String targetProject, String packageName) {
//        super(serviceVm, targetProject, packageName);
//    }
//
//    public void generatorServiceMockImpl(String tableName) {
...
//                file.mkdirs();
//            }
//            String serviceImplFile = serviceImplDirectory + tableName + "ServiceMockImpl.java";
